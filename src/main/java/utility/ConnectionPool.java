...
public class ConnectionPool {
    ...
    private Vector<Connection> conPool = new Vector<Connection>(CON_POOL_SIZE, 1);
    private Vector<Connection> activeConnections = new Stack<Connection>();
    ...
    static {
        try (FileInputStream f = new FileInputStream("C:\\Users\\Mirian\\eclipse-workspace\\CarService\\src\\main\\resources\\database.properties")) {
            p.load(f);
        } catch (IOException e) {
            LOGGER.info(e);
        }
